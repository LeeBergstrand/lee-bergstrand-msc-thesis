...
\subsection{AssignmentCache and Assignment Performance}
...
\begin{figure}[!ht]
  \centering
	\includegraphics[width=0.80\textwidth]{media/assignment_results_overview.pdf}
	 \caption{GenomePropertiesResults objects are created by combining the AssignmentCaches generate for multiple organisms. These caches can be from disparate sources such as InterProScan results files or lists of InterPro signatures provided by an remote server.}
