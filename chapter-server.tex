...
setting up complex multiple server deployments. These \gls{paas}, such as Google 
...
simplicity of a single user deployment with the scalability of multiple server 
deployments. Such platforms provide both attributes by only requiring developers 
to upload their Python code files to the platform and having the platform 
automate the rest of the deployment process. For example, load balancers and 
multiple copies of request handling processes are spun up by such platforms 
