...
data.} These endpoints return JSON documents and \gls{fasta} files that are generated 
...
\gls{http} request.} The example \gls{url} above is used to download a \gls{fasta} 
...
processes. A \gls{uwsgi} middleware component is used to connect these copies to a 
