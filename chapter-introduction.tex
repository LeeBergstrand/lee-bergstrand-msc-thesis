...
Libraries have been written to accelerate script development by helping 
...
increasingly being used in bioinformatics and is widely used by both researchers 
...
cock2009biopython} or visualizing biochemical pathways as graph networks 
...
tightly integrated with Python-based data science and emerging machine learning 
tools found within the Scipy 
\cite{scipystack} ecosystem, including \gls{scikit}-learn. Pygenprop is 
discussed at length in Chapter \ref{Pygenprop}. Further details on the 
differences between it and existing pathway bioinformatics libraries can be 
found in Section \ref{pygenprop-summary}.

Due to a lack of coding skills among biologists, there is a need for dedicated 
...
web pages to learn about more details of the pathways visualized in their heat 
...
Micromeda, the software presented within this thesis, more effectively conveys 
...
biochemical pathways (e.g. complex cellular components such as flagella), the 
