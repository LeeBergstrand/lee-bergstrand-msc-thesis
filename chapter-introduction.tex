...
\subsection{Software Architecture Overview} \label{why-micromeda-files}
...
\section{An Overview of the Genome Properties Database, InterPro, and 
...
\subsection{The InterPro Consortium of Protein Databases} \label{InterProDatabases}
...
\subsection{InterProScan} \label{overview-interproscan}
...
\subsection{The Genome Properties Database} \label{genome-properties-overview}
...
\subsubsection{Assignment of Genome Properties to an Organism}
