...
\hypersetup{
    ...
    pdfsubject={Comparitive Genomics Software},  % subject: CHANGE THIS TEXT! and uncomment this line
...
\input{chapter-genome-properties.tex}
\input{chapter-pygenprop.tex}
\input{chapter-server.tex}
\input{chapter-client.tex}
